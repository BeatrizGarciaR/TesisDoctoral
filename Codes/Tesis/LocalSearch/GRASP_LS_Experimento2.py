...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 16:14:58 2023
...
localsearch = 0
elapsedtimeStop = 18000 # 5 horas
modelStopTime = 360 # 6 minutos 
alpha_def = 0.30
            ...
            for verif in rates:
                ...
                if TotalAccidentes != 0:
                    ...
                    while sumaelapsed < elapsedtimeStop and iteracionGRASP < maxIterGRASP:
                        ...
                        colnames = ["name", "I size", "L size", "S size", "prob verif", "0", "time", "elapsed time", "best obj", "best bound", "gap %", "status", "LS"]

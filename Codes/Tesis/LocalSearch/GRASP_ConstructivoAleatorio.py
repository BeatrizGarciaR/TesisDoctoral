                    ...
                    if TotalAccidentes != 0:
                        ...
                        while sumaelapsed < elapsedtimeStop and iteracionGRASP < maxIterGRASP:
                            ...
                            with open('SolutionX_DemandFixed_'+str(len(I))+str('_')
                                              +str(len(L))+str('_')
                                              +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1]) + '_' + str(verif) + '_' + str(rep)+'.txt', 'w') as solutionX:            
                            ...
                            colnames = ["name", "I size", "L size", "S size", "prob verif", "rep", "time", "elapsed time", "best obj", "best bound", "gap %"]
                            for column in range(len(colnames)):
                                sheet.write(0, column, colnames[column])
                            name = str('Instance')+str('_')+str(len(I))+str('_')+str(len(L))+str('_')+str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)
                            ...
                            with open('data_DemandFixed_'+str(len(I))+str('_')
                                              +str(len(L))+str('_')
                                              +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)+'.csv', 'w') as fi:
                            ...
                            f = open ('Resultados_Prueba_DemandFixed_'
                                          +str(len(I))+str('_')
                                          +str(len(L))+str('_')
                                          +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)+'.txt','w')
                            ...
                            lectura = open ('Resultados_Prueba_DemandFixed_'
                                          +str(len(I))+str('_')
                                          +str(len(L))+str('_')
                                          +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)+'.txt','r')
                            lectura.readline()
                            lectura.readline()
                            ...
                            if model.objVal > valorObjetivo:
                                ...
                                with open('SolutionX_DemandFixed_'+str(len(I))+str('_')
                                              +str(len(L))+str('_')
                                              +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)+'.txt', 'a') as solutionX: 
                                ...
                                coberturas = open ('Coberturas_DemandFixed_'
                                              +str(len(I))+str('_')
                                              +str(len(L))+str('_')
                                              +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)+'.txt','a')                      
                                        ...
                                        for j in range(len(L)):
                                            ...
                                            if j not in potentialSiteActivos and prob_aux > probVerificacion:  #LS1
                                                ...
                                                if 1 == 1:
                                                    ...
                                                    with open('data_DemandFixed_'+str(len(I))+str('_')
                                                                  +str(len(L))+str('_')
                                                                  +str(len(S))+ '_' + str(eta[0]) + "_" + str(eta[1])+ '_' + str(verif) + '_' + str(rep)+'.csv', 'a') as f: #Cambiar de w a a
                                                        writer = csv.writer(f)

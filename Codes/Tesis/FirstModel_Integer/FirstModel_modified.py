...
sheet = book.add_sheet('Tesis_FirstModelModified_150924', cell_overwrite_ok=True)
            ...
            #for rep in range(repeticiones):
                ...
                for s in range(len(S)):        
                    for l in L:
                        for i in I:
                            if S[s][i-1][0] != 0:
                                y_vars[s+1,l,1,i] = model.addVar(vtype=GRB.INTEGER, 
                ...
                with open('data_FirstModel_Modified_150924_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Prueba_FirstModel_Modified_150924_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                model.write('model_FirstModel_Modified_150924_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                book.save('Tesis_FirstModel_Modified_150924_'+str(eta[0])+'_'+str(eta[1])+'.xls') 

...
f = open ('Resultados_Prueba_'
              ...
              +str(len(N))+str('_')
              +str(len(S))+str('_')
              +str('Solution3_aik=0_todos')+'_.txt','w')
...
model.write('model_'+str(len(I))+str('_')
              ...
              +str(len(K))+str('_')
              +str(len(N))+str('_')
              +str(len(S))+str('_')+str('Solution3_aik=0_todos')+'_.lp')
model.write('model_'+str(len(I))+str('_')
              +str(len(L))+str('_')
              +str(len(K))+str('_')
              +str(len(N))+str('_')
              +str(len(S))+str('_')+str('Solution3_aik=0_todos')+'_.mps')
...
resultados = open ('Resultados_Prueba_'
              ...
              +str(len(K))+str('_')
              +str(len(N))+str('_')
              +str(len(S))+str('_')+str('Solution3_aik=0_todos')+'_.txt','r')
...
fobj = open ('FObj_'
              ...
              +str(len(K))+str('_')
              +str(len(N))+str('_')
              +str(len(S))+str('_')+str('Solution3_aik=0_todos')+'_.txt','w')

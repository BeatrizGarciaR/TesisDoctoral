# -*- coding: utf-8 -*-
"""
Created on Fri Nov 10 19:00:46 2023
...
sheet = book.add_sheet('Tesis_NewModel_Supuesto_070224', cell_overwrite_ok=True)
            ...
            #for rep in range(repeticiones):
                ...
                for s in range(len(S)):
                    ...
                    for i in I:
                        ...
                        if S[s][i-1][0] != 0 or S[s][i-1][1] != 0:
                            if S[s][i-1][0] != 0:
                                amb += gp.quicksum(y_vars[s+1,l,2,i] + v_vars[s+1,l,2,i] for l in L)
                            if S[s][i-1][1] != 0 and S[s][i-1][0] == 0:
                                amb += gp.quicksum(y_vars[s+1,l,2,i] + v_vars[s+1,l,2,i] for l in L)
                ...
                with open('data_NewModel_Supuesto_070224_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                # model.write('model_NewModel_Supuesto_070224_'+str(len(I))+str('_')
                #               +str(len(L))+str('_')
                #               #+str(len(K))+str('_')
                #               #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Prueba_NewModel_Supuesto_070224_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                book.save('Tesis_NewModel_Supuesto_070224_'+str(eta[0])+'_'+str(eta[1])+'.csv') 

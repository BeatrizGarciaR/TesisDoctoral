...
sheet = book.add_sheet('Tesis_Matheuristic_200125', cell_overwrite_ok=True)

book1 = xlwt.Workbook(encoding="utf-8",style_compression=0)
sheet1 = book1.add_sheet('Tesis_Matheuristic1_200125', cell_overwrite_ok=True)
    ...
    for jconj in range(len(tamaños_L)):
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                with open('data_Matheuristic_200125_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Matheuristic_200125_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                #book.save('Tesis_Matheuristic_200125_'+str(eta[0])+'_'+str(eta[1])+'.xls') 
                ...
                soluciones = open('Solutions_Matheuristic_200125_'
                                  +str(tamaños_I[iconj])+str('_')
                                  +str(tamaños_L[jconj])+str('_')
                                  +str(tamaños_S[sconj])+'_'
                ...
                best = open('Mejoras_Matheuristic_200125_'
                                  +str(tamaños_I[iconj])+str('_')
                                  +str(tamaños_L[jconj])+str('_')
                                  +str(tamaños_S[sconj])+'_'
                                  +str(eta[0])+'_'+str(eta[1])+'.txt', "w")
                ...
                mejor = open('Best_Matheuristic_200125_'
                                  +str(tamaños_I[iconj])+str('_')
                                  +str(tamaños_L[jconj])+str('_')
                                  +str(tamaños_S[sconj])+'_'
                                  +str(eta[0])+'_'+str(eta[1])+'.txt', "w")
                ...
                for i1 in range(len(pares_nocero)):
                    ...
                    for j in range(len(pares_nocero)):
                        ...
                        if cambio1 != cambio2:
                            ...
                            f = open ('Resultados_Matheuristic_200125_New_'
                                          +str(len(I))+str('_')
                                          +str(len(L))+str('_')
                                          #+str(len(K))+str('_')
                                          #+str(len(N))+str('_')
                ...
                g = open('Best_Matheuristic_200125_'
                          +str(tamaños_I[iconj])+str('_')
                          +str(tamaños_L[jconj])+str('_')
                          +str(tamaños_S[sconj])+'_'
                          +str(eta[0])+'_'+str(eta[1])+'.txt')
                ...
                book.save('Tesis_Matheuristic_200125_'+str(eta[0])+'_'+str(eta[1])+'.xls') 
                book1.save('Tesis_Matheuristic_Mejoras_200125_'+str(eta[0])+'_'+str(eta[1])+'.xls') 
#book.save('Tesis_Matheuristic_200125_'+str(eta[0])+'_'+str(eta[1])+'.xls') 

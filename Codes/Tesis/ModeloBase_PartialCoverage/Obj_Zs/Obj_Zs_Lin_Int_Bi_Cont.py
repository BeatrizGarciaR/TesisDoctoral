# -*- coding: utf-8 -*-
"""
Created on Wed Jan 15 12:12:51 2025
...
sheet = book.add_sheet('Tesis_ObjZsLinIntBiCont_150125', cell_overwrite_ok=True)
    ...
    for jconj in range(len(tamaños_L)):
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                for l in L:
                    for k in K:
                        x_vars[l,k] = model.addVar(vtype=GRB.CONTINUOUS, 
                ...
                for s in range(len(S)):        
                    for l in L:
                        for i in I:
                            if S[s][i-1][0] != 0:
                                y_vars[s+1,l,1,i] = model.addVar(vtype=GRB.CONTINUOUS, 
                                                name="dispatched "+str(s+1)+str(' ')+str(l)+str(' ')+str(1)+str(' ')+str(i))
                                cantVarY += 1
                                
                                y_vars[s+1,l,2,i] = model.addVar(vtype=GRB.CONTINUOUS, 
                ...
                for s in range(len(S)):
                    for i in I:
                        if (S[s][i-1][0] + S[s][i-1][1]) > 0:
                            g_vars[s+1,i] = model.addVar(vtype=GRB.BINARY, 
                ...
                for s in range(len(S)):
                    for i in I:
                        if (S[s][i-1][0] + S[s][i-1][1]) > 0:
                            ...
                            h_vars[s+1,i] = model.addVar(vtype=GRB.BINARY, 
                ...
                for s in range(len(S)):
                    for i in I:
                        if (S[s][i-1][0] + S[s][i-1][1]) > 0:
                            ...
                            w_vars[s+1,i] = model.addVar(vtype=GRB.BINARY,
                ...
                with open('data_ObjZs_Scenarios_Line_Int_Bi_Cont_150125_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Prueba_ObjZs_Scenarios_Line_Int_Bi_Cont_150125_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                # model.write('model_ObjZs_Scenarios_Line_Int_Bi_Cont_150125_'+str(len(I))+str('_')
                #               +str(len(L))+str('_')
                #               #+str(len(K))+str('_')
                #               #+str(len(N))+str('_')
                ...
                book.save('Tesis_ObjZs_Scenarios_Line_Int_Bi_Cont_150125_'+str(eta[0])+'_'+str(eta[1])+'.xls') 

...
#   }
# 
#   aux_1 <- as.data.frame(read.csv(paste('Tesis_ObjZs_M2M1_280224_',len_L[1],'_',eta[1],'_',eta[2],'.csv', sep="")))
# 
#   aux_bb <- as.data.frame(aux_1[filas, c(2,4,7)])
  ...
  for (i in 1:length(len_I)){
    for (l in 1:length(len_L)){
      for (s in 1: length(len_S)){
        accidents <- suppressWarnings(as.data.frame(read.table(paste('Accidents_ObjZs_M2M1_280224', len_I[i], '_', len_L[l], '_', len_S[s], '.txt', sep=""))))
...
# pdf(paste("Coverage_Obj_Zs_M2M1_280224_",len_L[1],'_',eta[1],'_',eta[2],".pdf", sep=""), width = 10)
# par(mfrow = c(1,  length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
# for (a in 1:length(amb[,1])){
#   eta = amb[a,]
...
# #coverage graphics
# pdf(paste("Coverage_Obj_Zs_M2M1_280224_",len_L[1],'_',eta[1],'_',eta[2],"_1.pdf", sep=""), width = 10)
# par(mfrow = c(1,  length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
# for (a in 1:length(amb[,1])){
#   eta = amb[a,]
#   #pdf(paste("Coverage_",eta[1],"_",eta[2],".pdf", sep=""))

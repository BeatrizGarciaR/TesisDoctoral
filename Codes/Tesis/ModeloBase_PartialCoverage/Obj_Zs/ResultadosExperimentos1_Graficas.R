...
for (a in 1:length(amb[,1])){
  ...
  if(a == 1){
    plot(matrix_1[1:5], pch=15, col=1, cex=1.5, ylim=c(min(matrix_1)-2,max(matrix_bestbound_1)+2),
  ...
  #                 "BLS and",eta[2],"ALS ambulances", sep=" "))
  # axis(1, at=1:5, labels=len_I)
  lines(matrix_1[1:5], lwd=3, col=1)
  points(matrix_bestbound_1[1:5], pch=15, cex=1.5, col=1)
  lines(matrix_bestbound_1[1:5], lwd=3, col=1, lty=2)
  points(matrix_1[6:10], pch=16, cex=1.5, col=2)
  lines(matrix_1[6:10], lwd=3, col=2)
  points(matrix_bestbound_1[6:10], pch=16, cex=1.5, col=2)
  lines(matrix_bestbound_1[6:10], lwd=3, col=2, lty=2)
  points(matrix_1[11:15], pch=17, cex=1.5, col=3)
  lines(matrix_1[11:15], lwd=3, col=3)
  points(matrix_bestbound_1[11:15], pch=17, cex=1.5, col=3)
  lines(matrix_bestbound_1[11:15], lwd=3, col=3, lty=2)
  points(matrix_1[16:20], pch=18, cex=1.5, col=4)
  lines(matrix_1[16:20], lwd=3, col=4)
  points(matrix_bestbound_1[16:20], pch=18, cex=1.5, col=4)
  lines(matrix_bestbound_1[16:20], lwd=3, col=4, lty=2)
  points(matrix_1[21:25], pch=19, cex=1.5, col=6)
  lines(matrix_1[21:25], lwd=3, col=6)
  points(matrix_bestbound_1[21:25], pch=19, cex=1.5, col=6)
  lines(matrix_bestbound_1[21:25], lwd=3, col=6, lty=2)
...
for (a in 1:length(amb[,1])){
  ...
  if(a == 1){
    plot(matrix[1:5], pch=15, col=1, cex=1.5, ylim=c(0,4000),
...
for (a in 1:length(amb[,1])){
  ...
  #pdf(paste("Timeval_",eta[1],"_",eta[2],".pdf", sep=""))
  if(a == 1){
    plot(matrix_1[1:5], pch=15, col=1, cex=1.5, ylim=c(0,4000),
         cex.lab=2.7, cex.axis = 2.5, xlab="demand points", ylab="runtime in seconds", 
         xaxt= "n", tck = 0.02) #ann = FALSE,
    title(paste(eta[1],"BLS and",eta[2],"ALS ambulances", sep=" "), cex.main = 3.5)
  } else{
...
for (a in 1:length(amb[,1])){
  ...
  if(a == 1){
    plot(as.numeric(prom_coverage[a*5-4, 5:9]), pch=15, col=1, cex=1.5, ylim=c(0,100),

...
# 
# 
# ##### mean coverage percentage graphics
...
# write.csv(prom_coverage, file = paste('MeanCoverageTotal_ObjZs_Scenarios_161123_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
# 
# 
# for (a in 1:length(amb[,1])){
#   eta = amb[a,]

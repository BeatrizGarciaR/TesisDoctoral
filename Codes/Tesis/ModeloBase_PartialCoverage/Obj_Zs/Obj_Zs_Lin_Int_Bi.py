...
sheet = book.add_sheet('Tesis_ObjZsLinIntBi_150125', cell_overwrite_ok=True)
    ...
    for jconj in range(len(tamaños_L)):
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                with open('data_ObjZs_Scenarios_Line_Int_Bi_150125_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Prueba_ObjZs_Scenarios_Line_Int_Bi_150125_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                # model.write('model_ObjZs_Scenarios_Line_Int_Bi_150125_'+str(len(I))+str('_')
                #               +str(len(L))+str('_')
                #               #+str(len(K))+str('_')
                #               #+str(len(N))+str('_')
                ...
                book.save('Tesis_ObjZs_Scenarios_Line_Int_Bi_150125_'+str(eta[0])+'_'+str(eta[1])+'.xls') 

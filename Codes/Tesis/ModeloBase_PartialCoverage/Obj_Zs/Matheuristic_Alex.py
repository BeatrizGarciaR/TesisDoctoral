# -*- coding: utf-8 -*-
"""
Created on Fri Jun 20 03:48:38 2025
...
sheet = book.add_sheet('Tesis_Matheuristic_200625', cell_overwrite_ok=True)

book1 = xlwt.Workbook(encoding="utf-8",style_compression=0)
sheet1 = book1.add_sheet('Tesis_Matheuristic1_200625', cell_overwrite_ok=True)
        ...
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                for s in range(len(S)):
                    ...
                    # Restricción 6: Desactivar alpha (Total)
                    for i in I:
                    ...
                    # Restricción 7: Desactivar beta (Total late)
                    for i in I:
                    ...
                    # Restricción 8: Desactivar beta (Total late)
                    for i in I:
                    ...
                    # Restricción 9: Desactivar delta (Partial)
                    for i in I:
                    ...
                    # Restricción 10: Desactivar delta (Partial)   
                    for i in I:
                    ...
                    # Restricción 11: Desactivar phi (Partial late)
                    for i in I:
                    ...
                    # Restricción 12: Desactivar phi (Partial late)
                    for i in I:
                ...
                with open('data_Matheuristic_200625_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                              +str(len(S))+'_'+str(eta[0])+'_'+str(eta[1])+'_0.csv', 'w') as f:
                    writer = csv.writer(f)
                ...
                f = open ('Resultados_Matheuristic_200625_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                              +str(len(S))+'_'+str(eta[0])+'_'+str(eta[1])+'_0.txt','w')
                ...
                names = ['dispatched', 'Total', 'Total late', 'Partial', 'Partial late', 'Null']
                name_ind = 0
                ...
                #book.save('Tesis_Matheuristic_200625_'+str(eta[0])+'_'+str(eta[1])+'.xls') 
                
                mejor = open('Best_Matheuristic_200625_'
                                  +str(tamaños_I[iconj])+str('_')
                                  +str(tamaños_L[jconj])+str('_')
                                  +str(tamaños_S[sconj])+'_'
                                  +str(eta[0])+'_'+str(eta[1])+'_0.txt', "w")
                ...
                for iteraciones in range(num_iteraciones):
                    ...
                    if iteraciones > 0:
                        ...
                        g = open('Best_Matheuristic_200625_'
                                  +str(tamaños_I[iconj])+str('_')
                                  +str(tamaños_L[jconj])+str('_')
                                  +str(tamaños_S[sconj])+'_'
                                  +str(eta[0])+'_'+str(eta[1])
                                  +'_'+str(iteraciones-1)+'.txt', "r")
                        ...
                        for s in range(len(S)):
                            ...
                            #Restricción 3.1: No localizar en más de cant/2 sitios potenciales
                            model.addConstr(gp.quicksum(x_vars[l,k] for l in L for k in K) <= count_xs - 1, "c3_1")
                        ...
                        with open('data_Matheuristic_200625_'+str(len(I))+str('_')
                                      ...
                                      #+str(len(K))+str('_')
                                      #+str(len(N))+str('_')
                                      +str(len(S))+'_'+str(eta[0])+'_'+str(eta[1])
                                      +'_'+str(iteraciones)+'.csv', 'w') as f:
                            writer = csv.writer(f)
                            writer.writerows(model._data)
                    ...
                    while sale == 1:
                        ...
                        soluciones = open('Solutions_Matheuristic_200625_'
                                          +str(tamaños_I[iconj])+str('_')
                                          +str(tamaños_L[jconj])+str('_')
                                          +str(tamaños_S[sconj])+'_'
                                          +str(eta[0])+'_'+str(eta[1])
                        ...
                        best = open('Mejoras_Matheuristic_200625_'
                                          +str(tamaños_I[iconj])+str('_')
                                          +str(tamaños_L[jconj])+str('_')
                                          +str(tamaños_S[sconj])+'_'
                                          +str(eta[0])+'_'+str(eta[1])
                        ...
                        for i1 in range(len(pares_nocero)):
                            ...
                            for j in range(len(pares_nocero)):
                                ...
                                if cambio1 != cambio2:
                                    ...
                                    f = open ('Resultados_Matheuristic_200625_New_'
                                                  +str(len(I))+str('_')
                                                  +str(len(L))+str('_')
                                                  #+str(len(K))+str('_')
                                                  #+str(len(N))+str('_')
            ...
            print("el número de iteraciones es :" + str(iteraciones))
                
            book.save('Tesis_Matheuristic_200625_'+str(eta[0])+'_'+str(eta[1])+'.xls') 
            book1.save('Tesis_Matheuristic_Mejoras_200625_'+str(eta[0])+'_'+str(eta[1])+'.xls') 

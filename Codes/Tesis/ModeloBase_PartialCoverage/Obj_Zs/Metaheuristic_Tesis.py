# -*- coding: utf-8 -*-
"""
Created on Mon Sep  8 13:54:41 2025
...
sheet = book.add_sheet('Tesis_Metaheuristic_080925', cell_overwrite_ok=True)

book1 = xlwt.Workbook(encoding="utf-8",style_compression=0)
sheet1 = book1.add_sheet('Tesis_Metheuristic1_080925', cell_overwrite_ok=True)
    ...
    for jconj in range(len(tamaños_L)):
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                f = open ('Resultados_Metaheuristic_080925_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')

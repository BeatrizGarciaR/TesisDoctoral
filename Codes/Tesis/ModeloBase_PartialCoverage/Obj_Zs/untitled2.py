...
sheet = book.add_sheet('Tesis_ObjZs_Scenarios_171123', cell_overwrite_ok=True)
...
for iconj in range(len(tamaños_I)):
    for jconj in range(len(tamaños_L)):
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                with open('data_ObjZs_Scenarios_171123_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Prueba_ObjZs_Scenarios_171123_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                # coberturas = open ('Coberturas_ObjZs_Scenarios_171123_'
                #               +str(len(I))+str('_')
                #               +str(len(L))+str('_')
                #               +str(len(S))+'_'+str(eta[0])+'_'+str(eta[1])+'.txt','w')                      
                
                # lectura = open ('Resultados_Prueba_ObjZs_Scenarios_171123_'
                #               +str(len(I))+str('_')
                #               +str(len(L))+str('_')
    ...
    #             feasible.close()
                ...
                book.save('Tesis_ObjZs_Scenarios_171123_'+str(eta[0])+'_'+str(eta[1])+'.xls') 

...
counti = 0
#for (i in len_I){
pdf(paste("Objective_Metaheuristic_080925_",len_L[1],'_',eta[1],'_',eta[2],"_Comparaciones.pdf", sep=""), width = 10)
...
for (a in 1:length(amb[,1])){
  ...
  aux_0 <- as.data.frame(read.csv(paste('Tesis_Metaheuristic_080925_',len_L[1],'_',eta[1],'_',eta[2],'_Comparaciones.csv', sep="")))
...
counti = 0
#for (i in len_I){
pdf(paste("Objective_Metaheuristic_080925_",len_L[1],'_',eta[1],'_',eta[2],"_1_Comparaciones.pdf", sep=""), width = 10)
par(mfrow = c(1, length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  # run time
  eta <- amb[a,]
  ...
  aux_bb1 <- as.data.frame(aux_0[filas, c(2,4,7)])
  #print(aux_bb)
  matrix_bestbound1_1 <- matrix(nrow=length(len_I), ncol=length(len_S))
  colnames(matrix_bestbound1_1) <- len_S
  rownames(matrix_bestbound1_1) <- len_I
  count = 1
  for (s in 1:length(len_I)){
    for (l in 1:length(len_S)){
      #matrix[s,l] = aux[count,3]
      if (is.na(aux_bb1[count,3]) == FALSE){
        matrix_bestbound1_1[l,s] = aux_bb1[count,3]
      }
      else{
        matrix_bestbound1_1[l,s] = 0
      }
      count = count + 1
    }
  }
  ...
  #                 "BLS and",eta[2],"ALS ambulances", sep=" "))
  # axis(1, at=1:5, labels=len_I)
  lines(matrix_1[1:length(len_I)], lwd=3, col=1)
  points(matrix_bestbound_1[1:length(len_I)], pch=15, cex=1.5, col=1)
  lines(matrix_bestbound_1[1:length(len_I)], lwd=3, col=1, lty=2)
  points(matrix_bestbound1_1[1:length(len_I)], pch=15, cex=1.5, col=1)
  lines(matrix_bestbound1_1[1:length(len_I)], lwd=3, col=1, lty=3)

  points(matrix_1[(length(len_I)+1):(2*length(len_I))], pch=16, cex=1.5, col=2)
  lines(matrix_1[(length(len_I)+1):(2*length(len_I))], lwd=3, col=2)
  points(matrix_bestbound_1[(length(len_I)+1):(2*length(len_I))], pch=16, cex=1.5, col=2)
  lines(matrix_bestbound_1[(length(len_I)+1):(2*length(len_I))], lwd=3, col=2, lty=2)
  points(matrix_bestbound1_1[(length(len_I)+1):(2*length(len_I))], pch=16, cex=1.5, col=2)
  lines(matrix_bestbound1_1[(length(len_I)+1):(2*length(len_I))], lwd=3, col=2, lty=3)

  points(matrix_1[(2*length(len_I)+1):(3*length(len_I))], pch=17, cex=1.5, col=3)
  lines(matrix_1[(2*length(len_I)+1):(3*length(len_I))], lwd=3, col=3)
  points(matrix_bestbound_1[(2*length(len_I)+1):(3*length(len_I))], pch=17, cex=1.5, col=3)
  lines(matrix_bestbound_1[(2*length(len_I)+1):(3*length(len_I))], lwd=3, col=3, lty=2)
  points(matrix_bestbound1_1[(2*length(len_I)+1):(3*length(len_I))], pch=17, cex=1.5, col=3)
  lines(matrix_bestbound1_1[(2*length(len_I)+1):(3*length(len_I))], lwd=3, col=3, lty=3)

  points(matrix_1[(3*length(len_I)+1):(4*length(len_I))], pch=18, cex=1.5, col=4)
  lines(matrix_1[(3*length(len_I)+1):(4*length(len_I))], lwd=3, col=4)
  points(matrix_bestbound_1[(3*length(len_I)+1):(4*length(len_I))], pch=18, cex=1.5, col=4)
  lines(matrix_bestbound_1[(3*length(len_I)+1):(4*length(len_I))], lwd=3, col=4, lty=2)
  points(matrix_bestbound1_1[(3*length(len_I)+1):(4*length(len_I))], pch=18, cex=1.5, col=4)
  lines(matrix_bestbound1_1[(3*length(len_I)+1):(4*length(len_I))], lwd=3, col=4, lty=3)

  points(matrix_1[(4*length(len_I)+1):(5*length(len_I))], pch=19, cex=1.5, col=6)
  lines(matrix_1[(4*length(len_I)+1):(5*length(len_I))], lwd=3, col=6)
  points(matrix_bestbound_1[(4*length(len_I)+1):(5*length(len_I))], pch=19, cex=1.5, col=6)
  lines(matrix_bestbound_1[(4*length(len_I)+1):(5*length(len_I))], lwd=3, col=6, lty=2)
  points(matrix_bestbound1_1[(4*length(len_I)+1):(5*length(len_I))], pch=19, cex=1.5, col=6)
  lines(matrix_bestbound1_1[(4*length(len_I)+1):(5*length(len_I))], lwd=3, col=6, lty=3)
...
#   #aux_0 <- as.data.frame(read.csv(paste('Tesis_Metaheuristic_080925_AllAmb.csv', sep="")))
...
counti = 0
#for (i in len_I){
pdf(paste("Time_Metaheuristic_080925_",len_L[1],'_',eta[1],'_',eta[2],"_Comparaciones.pdf", sep=""), width = 10)
par(mfrow = c(1, length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  # run time
  eta <- amb[a,]
  ...
  #print(matrix)
  aux_bb <- as.data.frame(aux_0[filas, c(2,4,13)])
  #print(aux_bb)
  matrix_bestbound <- matrix(nrow=length(len_I), ncol=length(len_S))
  colnames(matrix_bestbound) <- len_S
  rownames(matrix_bestbound) <- len_I
  ...
  #print(matrix_bestbound)
  aux_bb1 <- as.data.frame(aux_0[filas, c(2,4,14)])
  #print(aux_bb)
  matrix_bestbound1 <- matrix(nrow=length(len_I), ncol=length(len_S))
  colnames(matrix_bestbound1) <- len_S
  rownames(matrix_bestbound1) <- len_I
...
counti = 0
#for (i in len_I){
pdf(paste("Time_Metaheuristic_080925_",len_L[1],'_',eta[1],'_',eta[2],"_1_Comparaciones.pdf", sep=""), width = 10)
par(mfrow = c(1, length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  # run time
  eta <- amb[a,]
  ...
  aux_bb1_1 <- as.data.frame(aux_0[filas, c(2,4,14)])
  #print(aux_bb)
  matrix_bestbound1_1 <- matrix(nrow=length(len_I), ncol=length(len_S))
  colnames(matrix_bestbound1_1) <- len_S
  rownames(matrix_bestbound1_1) <- len_I
  ...
  for (s in 1:length(len_I)){
    for (l in 1:length(len_S)){
      #matrix[s,l] = aux[count,3]
      if (is.na(aux_bb1_1[count,3]) == FALSE){
        matrix_bestbound1_1[l,s] = aux_bb1_1[count,3]
      }
      else{
        matrix_bestbound1_1[l,s] = 0
      }
  ...
  if(a == 1){
    plot(matrix_1[1:length(len_I)], pch=15, col=1, cex=1.5, ylim=c(0,15000),
...
# 
#         full <- as.data.frame(read.table(paste('Full_Metaheuristic_080925_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
...
# 
# 
#         partial1 <- as.data.frame(read.table(paste('Partial1_Metaheuristic_080925_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
...
# 
# 
#         partial2 <- as.data.frame(read.table(paste('Partial2_Metaheuristic_080925_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
...
# 
# 
#         partial3 <- as.data.frame(read.table(paste('Partial3_Metaheuristic_080925_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
...
# 
# 
#         null <- as.data.frame(read.table(paste('Null_Metaheuristic_080925_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
...
#     }
#   }
#   colnames(accidents_covered) <- c("I", "L", "S", "% T", "% TL", "% P", "% PL", "% NULL")
#   write.csv(accidents_covered, file = paste('ExpectedCoverage_Metaheuristic_080925_', eta[1],'_',eta[2],'.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
#   aux <- cbind(accidents_covered, eta[1], eta[2])
#   colnames(aux) <- c("I", "L", "S", "% T", "% TL", "% P", "% PL", "% Null ", "BLS ambulances", "ALS ambulances")
#   accidents_covered_total <- rbind(accidents_covered_total, aux)
# }
# write.csv(accidents_covered_total, file = paste('ExpectedCoverageTotal_Metaheuristic_080925_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
# 
# 
...
#   }
# }
# colnames(prom_coverage) <- c("I", "L", "Amb 1", "Amb 2", "Mean % T", "Mean % TL", "Mean % P", "Mean % PL", "Mean % Null")
# write.csv(prom_coverage, file = paste('MeanCoverageTotal_Metaheuristic_080925_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
# 
# 
# #coverage mean scenarios graphics
# pdf(paste("Coverage_Metaheuristic_080925_",len_L[1],'_',eta[1],'_',eta[2],"Comparaciones.pdf", sep=""), width = 10)
# par(mfrow = c(1,  length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
# for (a in 1:length(amb[,1])){
#   eta = amb[a,]
...
#     #title(paste(eta[1], "BLS and",eta[2],"ALS ambulances", sep=" "), cex.main=3.5)
#   }
#   axis(1, at=1:5, labels=c("T", "TL", "P", "PL", "N"), cex.axis = 2.5, tck = 0.02)
...
#   }
# }
# colnames(prom_coverage_1) <- c("I", "L", "Amb 1", "Amb 2", "Mean % T", "Mean % TL", "Mean % P", "Mean % PL", "Mean % N")
# write.csv(prom_coverage_1, file = paste('MeanCoverageTotal_Metaheuristic_080925_1_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
# 
# 
# #coverage graphics
# pdf(paste("Coverage_Metaheuristic_080925_",len_L[1],'_',eta[1],'_',eta[2],"_1.pdf", sep=""), width = 10)
# par(mfrow = c(1,  length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
# for (a in 1:length(amb[,1])){
#   eta = amb[a,]
#   #pdf(paste("Coverage_",eta[1],"_",eta[2],"Comparaciones.pdf", sep=""))

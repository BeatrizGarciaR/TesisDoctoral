        ...
        for sconj in range(len(tamaños_S)):
            ...
            for l in range(len(L)):
                ...
                for i in range(len(I)):
                    if r_li[l][i] < 15:
                        coberturaDemanda += 1
                cantidadCobertura.append(coberturaDemanda)
            
            print("Cantidad Cobertura")
            print(cantidadCobertura)
            print( " ")
            ...
            #for i in range(eta[0]):
                if len(candidatosTipo1) < eta[0]:
                    indice = cantidadCobertura.index(max(cantidadCobertura))
                    indice1 = cantidadCobertura.index(max(cantidadCobertura)) + 1
                    if indice not in candidatosTipo1 and indice1 in L1:
                        candidatosTipo1.append(indice+1)
                        cantidadCobertura[indice] = -1
                    else:
                        cantidadCobertura[indice] = -1
            ...
            #for i in range(eta[1]):
                if len(candidatosTipo2) < eta[1]:
                    indice = cantidadCobertura.index(max(cantidadCobertura))
                    indice2 = cantidadCobertura.index(max(cantidadCobertura)) + 1
